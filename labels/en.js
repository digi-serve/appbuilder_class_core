...
module.exports = {
   ...
   "Step": "Step",
   "Add a step to this tutorial.": "Add a step to this tutorial.",
   "Choose Page or Tab": "Choose Page or Tab",
   "Create Tutorial": "Create Tutorial",
   "Click the page or tab that will start this tutorial":
      "Click the page or tab that will start this tutorial",
   "Please choose an item to highlight": "Please choose an item to highlight",
   "select": "select",
   "Click the 'select' button to pick an element to highlight.":
      "Click the 'select' button to pick an element to highlight.",
   "Click the 'target' button to select an element to highlight.":
      "Click the 'target' button to select an element to highlight.",
   "Active": "Active",
   "Page/Tab": "Page/Tab",
   ...
   "Seconds before auto transition": "Seconds before auto transition",
   "Seconds before hint is automatically transitioned.":
      "Seconds before hint is automatically transitioned.",
   "Number of seconds before hint is automatically transitioned.":
      "Number of seconds before hint is automatically transitioned.",
   "Sorry, try another element.": "Sorry, try another element.",
   "Right click the element you want to highlight.":
      "Right click the element you want to highlight.",
   ...
   "Enter a new Password (at least 8)": "Enter a new Password (at least 8)",
   ...
   "Formula": "Formula",
   "choose next operation": "choose next operation",
   "Query:": "Query:",
   "choose Root": "choose Root",
