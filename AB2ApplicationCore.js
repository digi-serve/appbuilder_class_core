...
// userID
		...
		// implement .queryNew()
		var newQueries = [];
		(attributes.queries || []).forEach((query) => {
...
// implement: datacollection().first().value()
	 ...
	 //  	})
		...
		attributes.objectListSettings 			= attributes.objectListSettings || {};
		this.objectListSettings 				= this.objectListSettings || {};
		this.objectListSettings.isOpen 			= JSON.parse(attributes.objectListSettings.isOpen || false);
		this.objectListSettings.searchText 		= attributes.objectListSettings.searchText || "";
		this.objectListSettings.sortDirection 	= attributes.objectListSettings.sortDirection || "asc";
		this.objectListSettings.isGroup 		= JSON.parse(attributes.objectListSettings.isGroup || false);
	...
	urlResolve(pointer) {
		...
		var parseStep = (obj, steps) => {
			...
			if (Array.isArray(obj)) {
				...
				obj = obj.find(function(o){ return o.id == key;});
